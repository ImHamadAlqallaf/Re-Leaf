//
//  StoreManagerProfileViewController.swift
//  ReLeaf
//
...
class StoreManagerProfileViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            self.performSegue(withIdentifier: "toMyStore", sender: self)
        case 1:
            self.performSegue(withIdentifier: "toOrderManagement", sender: self)
        case 2:
            handleLogout()
        default:
            break
